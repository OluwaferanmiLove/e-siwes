                ...
                <div class="col-lg-4 offset-lg-4 text-white">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" aria-describedby="emailHelp" name="email" value="{{ old('email') }}">
                            @error('email')
                        ...
                        <button type="submit" class="btn btn-primary btn-xl"> {{ __('Send Password Reset Link') }}</button>
                    </form>
                    <br>
